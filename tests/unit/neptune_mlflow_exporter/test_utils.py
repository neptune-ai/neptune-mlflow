...
from neptune_mlflow_exporter.impl.utils import (
    DirectoryUploadStrategy,
    FileUploadStrategy,
)


@patch("neptune_mlflow_exporter.impl.utils.ArtifactUploadStrategy._download_artifacts")
...
@patch("neptune_mlflow_exporter.impl.utils.ArtifactUploadStrategy._download_artifacts")
@patch("neptune_mlflow_exporter.impl.utils.DirectoryUploadStrategy.get_dir_size", return_value=1000)
